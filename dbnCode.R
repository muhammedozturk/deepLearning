...
###############################
dnn <- dbn.dnn.train(train.x, train.y, hidden = c(5,5),learningrate=i)
## predict by dnn
...
write.csv(sonucListGenel,file="C:/mainFrame/makaleler/deepLearnTuning/dokumanlar/dbn/learnRateSonuc.csv")
#############################