...
###############################
dnn <- sae.dnn.train(train.x, train.y, hidden = 3,learningrate=i)
## predict by dnn
...
write.csv(sonucListGenel,file="C:/mainFrame/makaleler/deepLearnTuning/dokumanlar/stacked/learnRateSonuc.csv")
#############################